...
<html lang="ru">
<head>
<title>๖ۣۜNero ๖ۣۜPc &bull;Главная </title>
<meta charset="utf-8">
...
Adobe Photoshop — это комплексное решение для профессиональной обработки цифровых изображений, которое содержит самые современные инструменты для работы с изображениями и новые возможности для реализации творческих идей, которые позволяют значительно повысить производительность. Редактируйте изображения с исключительной точностью, используйте новые интуитивно понятные инструменты и рабочие процессы для создания трехмерной графики, двухмерных проектов, а также фильмов </div> 	</div>
		...
		<div class="mov-mask flex-col ps-link" data-link="/recuva"><span class="fa fa-play"></span></div>



			</div>
	<a class="mov-t nowrap" href="/recuva">Recuva - Софт для восстановления любых файлов</a>
	<span class="tags">
	<div class="movie-text">
			<ul class="movie-lines">
				<li><div class="ml-label">Версия:</div><div class="ml-desc">v 1.53.1087</div></li>
				<li><div class="ml-label">Разработчик: </div> <div class="ml-desc">Pifiform</div></li>
				<li><div class="ml-label">Язык интерфейса:</div> <div class="ml-desc">Eng</div></li>
				<li><div class="ml-label">Разрядность:</div> <div class="ml-desc"> оба</div></li>
				<li><div class="ml-label">Лечение:</div> <div class="ml-desc"> Отсутвует </div></li>
			    <li><div class="ml-label">Размер:</div> <div class="ml-desc"> 5.3 мб </div></li>
			</ul>
...
Программа имеет простой интерфейс, как и любая программа Windows. Программу можно запустить через USB-накопитель. Программа также поддерживает такие ключевые форматы, как файловые системы FAT12, FAT16, FAT32, exFAT, NTFS, NTFS5, NTFS + EFS и другие. Программа способна восстанавливать все типы файлов. Сюда входят офисные документы, изображения, фотографии, видео, аудио, музыка, электронная почта и т. Д. Программа также может восстанавливать данные с жестких дисков ZIP, Firewire и USB.</div>	</div>
	</div><div class="mov clearfix">
		<div class="mov-i img-box">
		<img src="/img/img-sborki/notepads-app-.png" alt="Виндовс 11" />
		<div class="mov-mask flex-col ps-link" data-link="/notepadsapp.php"><span class="fa fa-play"></span></div>



			</div>
	<a class="mov-t nowrap" href="/notepadsapp.php">Notepads App - Минималистичный текстовый редактор</a>
	<span class="tags">
	<div class="movie-text">
			<ul class="movie-lines">
				<li><div class="ml-label">Версия:</div><div class="ml-desc"> v1.3.7.0</div></li>
				<li><div class="ml-label">Разработчик: </div> <div class="ml-desc">Jackie Liu‬</div></li>
				<li><div class="ml-label">Язык интерфейса:</div> <div class="ml-desc"> Eng </div></li>
				<li><div class="ml-label">Разрядность:</div> <div class="ml-desc"> Обе </div></li>
				<li><div class="ml-label">Лечение:</div> <div class="ml-desc"> Не требуеться </div></li>
			    <li><div class="ml-label">Размер:</div> <div class="ml-desc"> 33 мб </div></li>
			</ul>
			<div class="movie-desc2">Notepads - современный легкий текстовый редактор с минималистичным дизайном.</div>
				</div>
</div><div class="mov clearfix">
	<div class="mov-i img-box">
	...
	<div class="movie-text">
			<ul class="movie-lines">
				...
				<li><div class="ml-label">Язык интерфейса:</div> <div class="ml-desc"> All </div></li>
				<li><div class="ml-label">Разрядность:</div> <div class="ml-desc"> all </div></li>
				<li><div class="ml-label">Лечение:</div> <div class="ml-desc"> Ненужна </div></li>
