...
<div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,moimir,telegram"></div>
 ...
 Photoshop 2021 REPACK
<br>
<br>
			<ul class="mov-list">
			    
				<li><div class="mov-label">Версия:</div> <div class="mov-desc"> REPACK </div></li>
				<li><div class="mov-label">Разработчик:</div> <div class="mov-desc"> MIF SOFT (adobe)</div></li>
				...
				<li><div class="mov-label">Лечение:</div> <div class="mov-desc"> Интегрирована </div></li>
				<li><div class="mov-label">Размер:</div> <div class="mov-desc"> 1.6 Гб </div></li>
...
<div class="attach clearfix ignore-select">
	<a href="magnet:?xt=urn:btih:97083021cd66cf3b4b56ecdbf399fc52336ee923"><i class="fa fa-download"></i>Скачать с торрента</a> 
</div>
</div>
		...
		<br>
	<div class="fullnews">
  <br><br>Adobe Photoshop — это комплексное решение для профессиональной обработки цифровых изображений, которое содержит самые современные инструменты для работы с изображениями и новые возможности для реализации творческих идей, которые позволяют значительно повысить производительность. Редактируйте изображения с исключительной точностью, используйте новые интуитивно понятные инструменты и рабочие процессы для создания трехмерной графики, двухмерных проектов, а также фильмов<br><br>
	<b>Системные требования к компьютеру или ноутбуку:</b><br><br>Процессор Intel или AMD с поддержкой 64-разрядных вычислений, тактовой частотой не менее 2 ГГц и SSE 4.2 или более поздней версии<br>Объём оперативной памяти не менее 8 ГБ ОЗУ и больше;<br>HDD\SSD объёмом не менее 20 ГБ;<br>Видеоадаптер с поддержкой DirectX версии 9.0 или более поздней 2 Гб видеопамяти ГП;<br>
Дисплей с минимальным разрешением экрана не менее 1280 x 800 со 100-процентным <br><b>
...
<script type="text/javascript">
  VK.init({apiId: 7901799, onlyWidgets: true});
</script>
